    ...
    <div className="relative flex min-h-[100svh] flex-col overflow-hidden bg-rf-surface-base text-rf-on-surface">
      ...
      <nav className="fixed left-0 top-0 z-50 flex h-[92px] w-full items-center justify-between border-b border-rf-border-white-faint bg-rf-glass-bg px-6 backdrop-blur-[40px]">
        <Link href="/" className="flex items-center gap-2.5 text-[24px] font-bold tracking-tight text-rf-on-surface">
          ...
          >
            <defs>
              <linearGradient id="rf-signin-grad" x1="0" y1="0" x2="1" y2="1">
                <stop offset="0%" stopColor="#f59e0b" />
                <stop offset="100%" stopColor="#d97706" />
              </linearGradient>
              <linearGradient id="rf-signin-grad-2" x1="0" y1="0" x2="1" y2="1">
                <stop offset="0%" stopColor="#fbbf24" />
                <stop offset="100%" stopColor="#f59e0b" />
              </linearGradient>
            </defs>
            <rect x="0" y="0" width="64" height="64" rx="12" fill="url(#rf-signin-grad-2)" opacity="0.45" />
            <rect x="0" y="0" width="64" height="64" rx="12" fill="url(#rf-signin-grad-2)" opacity="0.75" transform="translate(2, 0)" />
            <rect x="0" y="0" width="64" height="64" rx="12" fill="url(#rf-signin-grad)" transform="translate(4, 0)" />
        ...
        <section className="w-full">
          <div className="auth-card-shell relative max-h-[calc(100svh-112px)] overflow-hidden rounded-[28px] p-5 shadow-2xl md:p-6">
            ...
            <div className="relative z-10">
              {/* Flow logo mark — placed at the top of the form card */}
              <div className="mb-6 flex justify-center">
                ...
                >
                  <defs>
                    <linearGradient id="rf-signin-card-grad" x1="0" y1="0" x2="1" y2="1">
                      <stop offset="0%" stopColor="#f59e0b" />
                      <stop offset="100%" stopColor="#d97706" />
                    </linearGradient>
                    <linearGradient id="rf-signin-card-grad-2" x1="0" y1="0" x2="1" y2="1">
                      <stop offset="0%" stopColor="#fbbf24" />
                      <stop offset="100%" stopColor="#f59e0b" />
                    </linearGradient>
                  </defs>
                  <rect x="0" y="0" width="64" height="64" rx="12" fill="url(#rf-signin-card-grad-2)" opacity="0.45" />
                  <rect x="0" y="0" width="64" height="64" rx="12" fill="url(#rf-signin-card-grad-2)" opacity="0.75" transform="translate(2, 0)" />
                  <rect x="0" y="0" width="64" height="64" rx="12" fill="url(#rf-signin-card-grad)" transform="translate(4, 0)" />
                  <g transform="translate(32, 32)" stroke="#ffffff" strokeWidth="3.5" strokeLinecap="round" fill="none">
                    <line x1="-22" y1="-10" x2="-6" y2="-10" />
                    <line x1="-22" y1="0"   x2="-6" y2="0" />
                    <line x1="-22" y1="10"  x2="-6" y2="10" />
