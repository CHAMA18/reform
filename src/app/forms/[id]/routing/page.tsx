...
/**
 * /forms/[id]/routing — manage AI smart routing rules for a form.
 */
export default async function FormRoutingPage({
  params,
}: {
  ...
  return (
    <AppShell activePath="/templates" brandSubtitle="AI routing">
      <div className="min-h-screen bg-rf-surface-base text-rf-on-surface">
        <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-12">
          ...
          <RoutingRulesPanel formId={form.id} />
        </div>
      </div>
    </AppShell>
  );
